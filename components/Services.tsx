...
export default function Services() {
  return (
    <section id="services" className="py-28 relative overflow-hidden">
      ...
      <div
        className="glow-orb w-[800px] h-[800px] bg-indigo-600 top-[50%] left-[50%]"
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  {/* Icon */}
                  <div
                    className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${service.color} border border-white/[0.06] flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300`}
                    style={{
